...
import { X, ArrowUpRight, CheckCircle2, Calendar, User, Sparkles, ExternalLink } from 'lucide-react';
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 lg:p-8 bg-black/85 backdrop-blur-md">
        ...
        >
          ...
          <div className="overflow-y-auto p-4 sm:p-6 space-y-6">
            ...
            {/* Meta Info Bar */}
            <div className={`grid grid-cols-2 ${project.behanceUrl ? 'sm:grid-cols-4' : 'sm:grid-cols-3'} gap-4 p-4 rounded-2xl bg-neutral-950/80 border border-neutral-800/60 text-sm`}>
              {project.client && (
